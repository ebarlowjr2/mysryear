...
async function fetchDiscover() {
  const base =
    ...
    (typeof window !== 'undefined' ? window.location.origin : 'https://mysryear.vercel.app')
      ...
      <div className="container-prose py-20">
        <div className="max-w-xl mx-auto card p-8 text-center">
          ...
          <p className="mt-3 text-slate-700">
            Please sign in to view and manage your scholarships.
          </p>
  ...
  return (
    <div className="container-prose py-10">
      ...
      <p className="mt-2 text-slate-700">
        Track what you&apos;ve applied to, what&apos;s next, and discover more.
      </p>
