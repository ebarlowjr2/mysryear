      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignup}>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border-2 border-gray-600 bg-slate-800 hover:bg-slate-700 transition-colors font-semibold text-white disabled:opacity-50 disabled:cursor-not-allowed"
          >
