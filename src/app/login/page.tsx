    ...
    <div className="card p-8">
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border-2 border-slate-300 bg-white hover:bg-slate-50 transition-colors font-semibold text-slate-700 disabled:opacity-50 disabled:cursor-not-allowed"
        >
